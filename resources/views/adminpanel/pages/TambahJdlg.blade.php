        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <form action="/TambahJdlg/store" method="post" enctype="multipart/form-data" class="form-horizontal">
                {{ csrf_field() }}
               <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tittle Gallery</label>
